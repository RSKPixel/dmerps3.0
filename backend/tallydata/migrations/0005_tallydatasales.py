...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tallydata', '0004_tallydataaccountmaster_tallydatacostcentre_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vno', models.CharField(blank=True, max_length=100, null=True)),
                ('vdt', models.DateField(blank=True, null=True)),
